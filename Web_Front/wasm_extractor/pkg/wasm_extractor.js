...
export class ExtractorSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ExtractorSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_extractorsession_free(ptr, 0);
    }
    /**
     ...
     * @param {string} region_json
     * @param {string} name
     * @param {string} folder
     * @returns {string}
     */
    analyze_chunk(region_json, name, folder) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(region_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(folder, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.extractorsession_analyze_chunk(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            deferred4_0 = ret[0];
            deferred4_1 = ret[1];
    ...
    detect(params_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.extractorsession_detect(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor(samples, sample_rate) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.extractorsession_new(ptr0, len0, sample_rate);
        this.__wbg_ptr = ret;
        ExtractorSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {Uint8Array}
     */
    slice_wav(region_json) {
        const ptr0 = passStringToWasm0(region_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.extractorsession_slice_wav(this.__wbg_ptr, ptr0, len0);
        var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v2;
    }
}
if (Symbol.dispose) ExtractorSession.prototype[Symbol.dispose] = ExtractorSession.prototype.free;
 ...
 * @returns {string}
 */
export function extractor_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.extractor_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
const ExtractorSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_extractorsession_free(ptr, 1));
