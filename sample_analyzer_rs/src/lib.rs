...
#[path = "Scananalyzers/acid.rs"]
pub mod acid;
#[path = "Scananalyzers/advanced_stats.rs"]
pub mod advanced_stats;
#[path = "Scananalyzers/amplitude.rs"]
pub mod amplitude;
pub mod analyze;
pub mod args;
#[path = "NameSorting/categorize.rs"]
pub mod categorize;
#[path = "Scananalyzers/cluster.rs"]
pub mod cluster;
#[path = "Decoders/decode.rs"]
pub mod decode;
pub mod discover;
#[path = "Scananalyzers/distortion.rs"]
pub mod distortion;
#[path = "Encoders/emit.rs"]
pub mod emit;
#[path = "Scananalyzers/envelope.rs"]
pub mod envelope;
#[path = "NameSorting/family.rs"]
pub mod family;
#[path = "Scananalyzers/feature_vec.rs"]
pub mod feature_vec;
#[path = "Scananalyzers/flux.rs"]
pub mod flux;
#[path = "Scananalyzers/framestats.rs"]
pub mod framestats;
#[path = "Scananalyzers/kmeans.rs"]
pub mod kmeans;
#[path = "NameSorting/label.rs"]
pub mod label;
#[path = "Scananalyzers/mfcc.rs"]
pub mod mfcc;
#[path = "Scananalyzers/moments.rs"]
pub mod moments;
#[path = "Scananalyzers/morphology.rs"]
pub mod morphology;
#[path = "NameSorting/normalize.rs"]
pub mod normalize;
#[path = "Scananalyzers/partials.rs"]
pub mod partials;
#[path = "Scananalyzers/pca.rs"]
pub mod pca;
pub mod peak;
#[path = "Scananalyzers/pitch.rs"]
pub mod pitch;
#[path = "Scananalyzers/root.rs"]
pub mod root;
pub mod run;
#[path = "Encoders/sidecar.rs"]
pub mod sidecar;
#[path = "Scananalyzers/spectrum.rs"]
pub mod spectrum;
#[path = "Scananalyzers/sqdist.rs"]
pub mod sqdist;
#[path = "Scananalyzers/stft.rs"]
pub mod stft;
#[path = "Encoders/stream.rs"]
pub mod stream;
#[path = "Scananalyzers/sustain.rs"]
pub mod sustain;
#[path = "Tagging/tags.rs"]
pub mod tags;
#[path = "Scananalyzers/tempo.rs"]
pub mod tempo;
#[path = "Scananalyzers/timbre.rs"]
pub mod timbre;
#[path = "Scananalyzers/transients.rs"]
pub mod transients;
pub mod version;
#[path = "Scananalyzers/vad.rs"]
pub mod vad;
